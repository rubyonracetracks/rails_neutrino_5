...
puts 'Making test/helpers/application_helper_test.rb exempt from Metrics/LineLength cop'
LineContaining.add_before('# END: Metrics/LineLength', '    - test/helpers/application_helper_test.rb', '.rubocop.yml')
