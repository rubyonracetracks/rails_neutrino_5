...
InsertFromFile.add_after('mod-04-02-static_pages_controller.txt', 'app/controllers/static_pages_controller.rb', 'class StaticPagesController < ApplicationController')
