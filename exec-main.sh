...
cd $DIR_APP && sh mod_app.sh '04-07' $TOGGLE_OUTLINE
...
cd $DIR_APP && sh mod_app.sh '09-06' $TOGGLE_OUTLINE
cd $DIR_APP && sh mod_app.sh '09-07' $TOGGLE_OUTLINE

cd $DIR_APP && sh mod_app.sh '10-01' $TOGGLE_OUTLINE
cd $DIR_APP && sh mod_app.sh '10-02' $TOGGLE_OUTLINE
cd $DIR_APP && sh mod_app.sh '10-03' $TOGGLE_OUTLINE
cd $DIR_APP && sh mod_app.sh '10-04' $TOGGLE_OUTLINE
cd $DIR_APP && sh mod_app.sh '10-05' $TOGGLE_OUTLINE
cd $DIR_APP && sh mod_app.sh '10-06' $TOGGLE_OUTLINE
